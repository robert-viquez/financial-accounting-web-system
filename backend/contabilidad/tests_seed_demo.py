...
class SeedDemoIntegrationTests(TestCase):
    ...
    def test_seed_es_reproducible_y_matematicamente_integro(self):
        ...
        self.assertEqual(ConfiguracionEmpresa.objects.get(pk=1).nombre, "ByteForge Tech Demo")
        self.assertEqual(ConfiguracionEmpresa.objects.get(pk=1).locale_predeterminado, "en")
